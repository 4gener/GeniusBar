namespace GeniusBar.Migrations
{
    ...
    public partial class Initial : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        Coupon_ID = c.Decimal(precision: 10, scale: 0),
                        Engineer_ID = c.Decimal(precision: 10, scale: 0),
                        User_ID = c.Decimal(precision: 10, scale: 0),
                    })
                .PrimaryKey(t => t.ID)
                .ForeignKey("GENIUSBAR.Coupons", t => t.Coupon_ID)
                .ForeignKey("GENIUSBAR.Users", t => t.User_ID)
                .ForeignKey("GENIUSBAR.Users", t => t.Customer_ID, cascadeDelete: true)
                .ForeignKey("GENIUSBAR.Users", t => t.Engineer_ID)
        ...
        public override void Down()
        {
            ...
            DropIndex("GENIUSBAR.Users", new[] { "Email" });
